...
//
//  File name :     32.1.c
//  Description :   To demonstrate a right-aligned pattern
//                  where '#' is printed on the diagonal
//                  (i == j), and '*' is printed elsewhere.
//                  Columns are traversed right-to-left.
